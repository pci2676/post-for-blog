...
log_slow_verbosity      = query_plan#log-queries-not-using-indexes
...
#innodb_flush_log_at_trx_commit=0[mysqldump]
quick
quote-names
max_allowed_packet      = 16M[mysql]
#no-auto-rehash # faster start of mysql but no tab completion[isamchk]
key_buffer              = 16M#
